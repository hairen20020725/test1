# 欢迎使用你的秒哒应用代码包
秒哒应用链接
    URL:https://www.miaoda.cn/projects/app-7ua9s9vs9fr5

## 介绍

智能空调方案推荐工具 - 基于户型图分析，为普通家庭用户提供个性化的空调方案推荐，包括空调型号选择、数量计算和安装建议。

## 📚 文档导航

- **[管理后台访问说明](./ADMIN_ACCESS.md)** - 如何访问和使用管理后台
- **[数据库更新指南](./DATABASE_UPDATE_GUIDE.md)** - 详细的数据库操作指南
